...
public class StudentAdminStudentImportController extends BaseController {
    ...
    private static final Logger LOGGER = Logger.getLogger(StudentAdminStudentImportController.class);
    ...
    @ResponseBody
    public Result uploadStudent(MultipartFile file, HttpSession httpSession, ModelMap modelMap) throws Exception {
    ...
    private void addStudentsFormExcel(HttpSession httpSession, ModelMap modelMap) throws Exception {

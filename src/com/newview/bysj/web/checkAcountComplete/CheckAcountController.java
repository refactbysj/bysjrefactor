...
public class CheckAcountController extends BaseController {
     ...
     */
    @RequestMapping("/checkDataAccountByDeanList.html")
    @ResponseBody
    public PageInfo getDataAccountByDean(ModelMap modelMap, HttpSession httpSession) {
...
//        System.out.print(departmentAcountCompletedList);
...
//    public String redirectRoleByDepartment() {
//        return "checkAccountData/listAccountData";
//    }
    /**
     * 查看数据统计，最高角色是教研室主任
     ...
     * @return checkAccountData/listAccountData.jsp
     */
    @RequestMapping("/checkDataAccountByDepartmentList.html")
    @ResponseBody
    public PageInfo getDataAccountByDepartment(ModelMap modelMap, HttpSession httpSession) {
        PageInfo pageInfo = new PageInfo();
        //获取当前tutor
        Tutor tutor = tutorService.findById(CommonHelper.getCurrentTutor(httpSession).getId());
        //获取当前老师所在教研室的所有课题
...
//        modelMap.put("departmentDataList", departmentAcountCompletedList);
     ...
     */
    @RequestMapping(value = "/notCompletedTaskDoc.html", method = RequestMethod.GET)
     ...
     * @return checkAccountData/notCompletedList.jsp
     */
    @RequestMapping(value = "/notCompletedOpenningReport.html", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/notCompletedSchedule.html", method = RequestMethod.GET)
    ...
    此方法的逻辑和上面的方法相似，此处不再详细写
     */
    @RequestMapping(value = "/notCompletedTutorEvaluate.html", method = RequestMethod.GET)
    ...
    此方法的逻辑和上面的方法相似，此处不再详细写
     */
    @RequestMapping(value = "/notCompletedReviewerEvaluate.html", method = RequestMethod.GET)
    ...
    //未完成的答辩小组意见表的调转
    @RequestMapping(value = "/notCompletedGroupEvaluate.html", method = RequestMethod.GET)

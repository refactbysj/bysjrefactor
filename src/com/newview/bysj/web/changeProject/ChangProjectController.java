...
import com.newview.bysj.web.allocateProjectAndStudent.QueryCondition;
...
public class ChangProjectController extends BaseController {
    ...
    public String changProject(HttpSession httpSession, ModelMap modelMap, Integer pageNo, Integer pageSize, QueryCondition queryCondition, String title, HttpServletRequest httpServletRequest) {
        ...
        modelMap.put("changProject", "1");
        //用来区分功能
        GraduateProjectHelper.ACTION_EDIT_PROJECT(modelMap, true);
     ...
     * @param title 题目名称
     */
    @RequestMapping(value = "/getChangProjectData.html", method = RequestMethod.POST)
    @ResponseBody

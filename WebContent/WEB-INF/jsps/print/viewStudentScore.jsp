    ...
    <div class="row-fluid">
        ...
        <table
            ...
            <tr>
                ...
                <td>${empty (projectCommentGroup.qualityScore)?"未评分":projectCommentGroup.qualityScore}</td>
            </tr>
            <tr>
                <td>2</td>
                <td>完成任务书规定的要求与水平评分（0-10分）</td>
                <td>${empty (projectCommentGroup.completenessScore)?"未评分":projectCommentGroup.completenessScore}</td>
            </tr>
            <tr>
                <td>3</td>
                <td>论文内容的答辩陈述评分（0-10分）</td>
                <td>${empty (projectCommentGroup.replyScore)?"未评分":projectCommentGroup.replyScore}</td>
            </tr>
            <tr>
                <td>4</td>
                <td>回答问题的正确性评分（0-10分）</td>
                <td>${empty (projectCommentGroup.correctnessSocre)?"未评分":projectCommentGroup.correctnessSocre}</td>
            </tr>
            <tr>

...
<script type="text/javascript">
    function approveTaskDocByDirectorAndDean(taskDocId) {
        ...
        /* if (confirmApprove) {
         ...
         $("#departmentOfDepartmentAndDean"+taskDocId).html("<p>通过</p>");
         $("#deanOfDepartmentAndDean"+taskDocId).html("<p>通过</p>");
         $("#directorAndDean"+taskDocId).html("<a id='rejectOfDirectorAndDean
        ${taskDoc.id}' class='btn btn-danger btn-xs' onclick='rejectTaskDocByDirectorAndDean("+taskDocId+")'>退回</a>");
         myAlert("修改成功");
         return true;
         },
         error:function(){
    ...
    function rejectTaskDocByDirectorAndDean(taskDocId) {
        ...
        /* var confirmReject=window.confirm("确认退回？");
         ...
         $("#departmentOfDepartmentAndDean"+taskDocId).html("<p>退回</p>");
         $("#deanOfDepartmentAndDean"+taskDocId).html("<p>退回</p>");
         $("#directorAndDean"+taskDocId).html("<a id='approveOfDirectAndDean
        ${taskDoc.id}' class='btn btn-danger btn-xs' onclick='approveTaskDocByDirectorAndDean("+taskDocId+")'>通过</a>");
         myAlert("修改成功");
         return true;
         },
         error:function(){
    ...
    function approveTaskDocByDean(taskDocId) {
        ...
        /* if(confirmApprove){
         ...
         success:function(data){
         $("#statusOfDean"+taskDocId).html("<p>通过</p>");
         $("#dean"+taskDocId).html("<a id='rejectOfDean
        ${taskDoc.id}' class='btn btn-danger btn-xs' onclick='rejectTaskDocByDean("+taskDocId+")'>退回</a>")
         myAlert("修改成功");
         return true;
         },
         error:function(){
    ...
    function rejectTaskDocByDean(taskDocId) {
        ...
        /* if(confirmReject){
         ...
         success:function(data){
         $("#statusOfDean"+taskDocId).html("<p>退回</p>");
         $("#dean"+taskDocId).html("<a id='approveOfDean
        ${taskDoc.id}' class='btn btn-danger btn-xs' onclick='approveTaskDocByDean("+taskDocId+")'>通过</a>")
         myAlert("修改成功");
         return true;
         },
         error:function(){
    ...
    function approveTaskDocByDepartment(taskDocId) {
        ...
        /* if(confirmApprove){
         ...
         success:function(data){
         $("#statusOfDepartment"+taskDocId).html("<p>通过</p>");
         $("#director"+taskDocId).html("<a id='rejectOfDirector
        ${taskDoc.id}' class='btn btn-danger btn-xs' onclick='rejectTaskDocByDepartment("+taskDocId+")'>退回</a>")
         myAlert("修改成功");
         return true;
         },
         error:function(){
    ...
    function rejectTaskDocByDepartment(taskDocId) {
        ...
        /* if(confirmReject){
         ...
         success:function(data){
         $("#statusOfDepartment"+taskDocId).html("<p>退回</p>");
         $("#director"+taskDocId).html("<a id='approveOfDirector
        ${taskDoc.id}' class='btn btn-danger btn-xs' onclick='approveTaskDocByDepartment("+taskDocId+")'>通过</a>")
         myAlert("修改成功");
         return true;
         },
         error:function(){
                            ...
                            <sec:authorize ifAllGranted="ROLE_DEPARTMENT_DIRECTOR" ifNotGranted="ROLE_DEAN">
                                <td id="director${taskDoc.id}">
                                    <c:if test="${taskDoc.auditByDepartmentDirector.approve==false}">
                                        ...
                                        <a id="approveofDirector${taskDoc.id}" class="btn btn-danger btn-xs"
                                           onclick="approveTaskDocByDepartment${taskDoc.id}">通过</a>
                                    </c:if>
                                    <c:if test="${taskDoc.auditByDepartmentDirector.approve==true}">
                                        ...
                                        <a id="rejectOfDirector${taskDoc.id}" class="btn btn-danger btn-xs"
                                           onclick="rejectTaskDocByDepartment${taskDoc.id}">退回</a>
                                    </c:if>
                                </td>
                            </sec:authorize>
                            <!-- 只拥有院长的角色 -->
                            <sec:authorize ifAllGranted="ROLE_DEAN" ifNotGranted="ROLE_DEPARTMENT_DIRECTOR">
                                <td id="dean${taskDoc.id}">
                                    <c:if test="${taskDoc.auditByBean.approve==false}">
                                        ...
                                        <a id="approveOfDean${taskDoc.id}" class="btn btn-danger btn-xs"
                                           onclick="approveTaskDocByDean(${taskDoc.id})">通过</a>
                                    </c:if>
                                    <c:if test="${taskDoc.auditByBean.approve==true}">
                                        ...
                                        <a id="rejectOfDean${taskDoc.id}" class="btn btn-danger"
                                           onclick="rejectTaskDocByDean(${taskDoc.id})">退回</a>
                                    </c:if>
                                </td>
                            </sec:authorize>
                            <!-- 同时拥有院长和教研室主任角色 -->
                            <sec:authorize ifAllGranted="ROLE_DEAN,ROLE_DEPARTMENT_DIRECTOR">
                                <td id="directorAndDean${taskDoc.id}">
                                    <c:if test="${taskDoc.auditByBean.approve==false&&taskDoc.auditByDepartmentDirector.approve==false}">
                                        <a id="approveOfDirectAndDean${taskDoc.id}" class="btn btn-danger btn-xs"
                                           onclick="approveTaskDocByDirectorAndDean(${taskDoc.id})"><span>通过</span></a>
                                    </c:if>
                                    <c:if test="${taskDoc.auditByBean.approve==true&&taskDoc.auditByDepartmentDirector.approve==true}">
                                        <a id="rejectOfDirectorAndDean${taskDoc.id}" class="btn btn-danger btn-xs"
                                           onclick="rejectTaskDocByDirectorAndDean(${taskDoc.id})"><span>退回</span></a>
                                    </c:if>
                                </td>
                            </sec:authorize>
                        </tr>
